...
public class Player : Character
{
    ...
    public void setLayerIndex(float value1, float value2, float value3)
    {
        animator.SetLayerWeight(0, value1);
        animator.SetLayerWeight(1, value2);
        animator.SetLayerWeight(2, value3);
    ...
    public void setNewWeapon(int value, int value2, Weapon newWeapon, GameObject _WeaponObject, AudioClip clip)
    {
        ...
        WeaponTypeIndex = newWeapon.GetWeaponTypeIndex();
        /*
    ...
    protected override void Start()
    {
        ...
        if (WeaponTypeIndex == 0 && !isUsingMinigun)
        {
